...
//   insert_task.wait();
//   // const auto tmp_path =
//   //     get_save_filename(save_path + ".tzj-test-start-" + std::to_string(0) + "-", active_window,
//   //                       consolidate_interval, max_points_to_insert);
//   //   index.save(tmp_path.c_str(), true);
...
//     // const auto save_path_inc =
//     //   get_save_filename(save_path + ".tzj-test-start-" + std::to_string(start) + "-", active_window,
//     //                     consolidate_interval, max_points_to_insert);
//     // index.save(save_path_inc.c_str(), true);
