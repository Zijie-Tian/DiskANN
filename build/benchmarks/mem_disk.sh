...
apps/search_memory_index  --data_type float --dist_fn l2 --index_path_prefix ${memindex_path_prefix} --query_file ${query_file}  --gt_file ${groundtruth} -K ${search_K} -L 10 20 30 40 50 100 --result_path ${result} --csv_file ${csv_file_mem}
