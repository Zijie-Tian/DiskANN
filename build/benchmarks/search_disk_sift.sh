...
./apps/search_disk_index  --data_type float --dist_fn l2 --index_path_prefix data/sift/disk_index_sift_base_R64_L75_A1.2 --query_file data/sift/sift_query.fbin  --gt_file data/sift/sift_query_learn_gt100 -K 10 -T 64 -W 4 -L 10 20 30 40 50 100 --result_path data/sift/res --num_nodes_to_cache 10000
